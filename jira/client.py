...
from jira.consistency import JiraConsistencyMixin
...
class ResultList(list):
    def __init__(
        self,
        iterable=None,  # Iterable | None = None,
        _startAt=0,  # int = 0,
        _maxResults=0,  # int = 0,
        _total=None,  # int | None = None,
        _isLast=None,  # bool | None = None,
        _nextPageToken=None,  # str | None = None,
    ):  # -> None:
        """Results List.
        ...
        self.iterable = list(iterable) if iterable else []  # type: list[ResourceType]
    ...
    #     return super(ResultList, self).__iter__()
...
class JIRA(object):
    ...
    def search_issues(
        ...
        jql_str,  # str,
        startAt=0,  # int = 0,
        maxResults=50,  # int = 50,
        validate_query=True,  # bool = True,
        fields="*all",  # str | list[str] | None = "*all",
        expand=None,  # str | None = None,
        properties=None,  # str | None = None,
        json_result=False,  # bool = False,
        use_post=False,  # bool = False,
        ...
        if json_result:
            ...
            r_json = self._get_json(  # type: dict[str, Any]
    ...
    def DEPRECATED_search_issues(self,
                      jql_str,
                      startAt=0,
                      maxResults=50,
                      validate_query=True,
    ...
    def enhanced_search_issues(
        self,
        jql_str,  # : str,
        nextPageToken=None,  # : str | None = None,
        maxResults=50,  # : int = 50,
        fields="*all",  # : str | list[str] | None = "*all",
        expand=None,  # : str | None = None,
        reconcileIssues=None,  # : list[int] | None = None,
        properties=None,  # : str | None = None,
        json_result=False,  # : bool = False,
        use_post=False,  # : bool = False,
    ):  # -> dict[str, Any] | ResultList[Issue]:
        ...
        search_params = { # type: dict[str, Any]
            "jql": jql_str,
            "fields": fields,
            "expand": expand,
            "properties": properties,
    ...
    def _fetch_pages_searchToken(
        ...
        base=JIRA_BASE_URL,  # : str = JIRA_BASE_URL,
        use_post=False,  # : bool = False,
        ...
        nextPageToken = page_params.get("nextPageToken")  # type: str | None
        items = []  # type: list[ResourceType]
...
class ConsistentJIRA3(JiraConsistencyMixin, JIRA3):
    pass


JIRA3 = ConsistentJIRA3
